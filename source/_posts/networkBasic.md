...
定义：将缓存服务器分布到用户访问集中到地区或网络中，用户访问网站资源时将访问指向最近的缓存服务器 ip
A：dns 解析记录里原 ip 映射结果
cname：cdn 服务商地址
cdn 回源：缓存服务器没有符合请求的资源时会回到源服务器请求资源，缓存后再响应用户

CDN 保持边缘节点与源站一致主要依赖以下策略：
- 缓存失效：通过 Cache-Control、ETag 或 Last-Modified。
- 主动刷新：通过 API 或回源策略。
- 事件驱动更新：源站通知 CDN 更新。